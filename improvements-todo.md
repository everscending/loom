...
- [ ] **IN PROGRESS — Prioritize closure and dependency impact.** Current recovery order favors a nearly-green ticket or a ticket that unlocks dependents over queue age alone. JOR-208, JOR-287, JOR-286, and JOR-244 are merged and closed. JOR-214's repaired manifest contract is in a serialized UI gate and still unlocks JOR-224/JOR-221/JOR-231. JOR-218's launchd-portable renderer guard is pushed and focused-green, but its old pregate was falsely attached to the new SHA by the gate bookkeeping race above; the ticket is leased until that verdict is retired and it can regate. JOR-206's shared identity-lock ownership repair is pushed with 58/58 focused and 618/618 logic checks; it remains leased pending a focused UI proof and still unlocks JOR-230/JOR-212. JOR-251's first false block produced the shared brief fix; its second block exposed genuinely unowned list/transition domain operations, now explicitly assigned to JOR-251 by a supervisor rescope before requeue. Planner scoring and holding tests remain TODO.
