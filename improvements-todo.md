...
- [x] **DONE — Keep viewer panes equal to active workers.** Patient
  ...
  death, plus a planted ownership-recovery mutation. Isolated branch
  `codex/viewer-durability-impl` implements the controller and pane ownership
  recovery at `aa9fa57` and `9859d88`; focused durability is 29/29, adjacent
  scheduler is 32/32, and the full suite is 1,347/1,347. A live recovery also
